...
image_ampl_x = rgb2gray(imread(strcat(data_directory, '/x_amp.jpg')));
image_ampl_y = rgb2gray(imread(strcat(data_directory, '/y_amp.jpg')));
image_ampl_z = rgb2gray(imread(strcat(data_directory, '/z_amp.jpg')));
...
surface_heightmap = surf(draw_height);
surface_heightmap.FaceAlpha = 0.9;
%surface_heightmap.EdgeAlpha = 0.2;
...
createButton(F, 'Summer', 10, {@callback_SetColormap, summer});
createButton(F, 'Winter', 11, {@callback_SetColormap, winter});
